package com.example.sireprojact
...
import com.example.sireprojact.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {

    private val viewModel: QuizViewModle.QuizViewModel by viewModels()
